...
const cartRoutes = require("./routes/cart")
const categoryRoutes = require("./routes/categories") // Added categories routes
const deliveryRoutes = require("./routes/delivery") // Added delivery routes import
const favoritesRoutes = require("./routes/favorites") // Added favorites routes
const orderRoutes = require("./routes/orders")
const productRoutes = require("./routes/products")
const settingsRoutes = require("./routes/settings") // Added settings routes import
...
app.get("/", (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      cart: "/api/cart",
      orders: "/api/orders",
      deliveries: "/api/deliveries", // Added delivery endpoint to API documentation
      favorites: "/api/favorites",
      ads: "/api/ads",
      admin: "/api/admin/users",
      settings: "/api/settings", // Added settings endpoint to documentation
    },
    health: "/health",
...
app.use("/api/cart", cartRoutes)
app.use("/api/categories", categoryRoutes)
app.use("/api/deliveries", deliveryRoutes) // Added delivery routes
app.use("/api/favorites", favoritesRoutes)
app.use("/api/orders", orderRoutes)
app.use("/api/products", productRoutes)
